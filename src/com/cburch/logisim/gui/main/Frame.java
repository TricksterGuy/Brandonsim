...
public class Frame extends LFrame implements LocaleListener {
	...
	public static final double[] ZOOM_OPTIONS = { 10, 20, 25, 50, 75, 100, 133, 150, 200, 250, 300, 400, 500 };
	...
	public ZoomModel       layoutZoomModel;
	...
	public Frame(Project proj) {
		...
		menubar = new LogisimMenuBar(this, proj, layoutZoomModel);
		...
		//attrTable.setHelpFrame(menubar.)
