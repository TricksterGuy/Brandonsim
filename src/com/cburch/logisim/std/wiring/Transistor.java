...
public class Transistor extends InstanceFactory {
	...
	private void updatePorts(Instance instance) {
		...
		ports[OUTPUT].setToolTip(Strings.getter("OUTPUT"));
		ports[INPUT].setToolTip(Strings.getter("INPUT"));
		ports[GATE].setToolTip(Strings.getter("GATE"));
	...
	public String getHelpPage() { return "wiring_transist"; }
}
